...
import SupplierPriceTiersTab from "../components/SupplierPriceTiersTab";
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          {activeTab === "details" ? (
            ...
            <SupplierPriceTiersTab supplierId={supplier.id} />
          )}
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-bgray-50 dark:bg-darkblack-500 border-b border-bgray-200 dark:border-darkblack-400">
                <th className="px-5 py-3 text-left text-xs font-semibold text-bgray-500 dark:text-bgray-400 uppercase tracking-wide">Supplier</th>
                ...
                <th className="px-5 py-3 text-left text-xs font-semibold text-bgray-500 dark:text-bgray-400 uppercase tracking-wide hidden lg:table-cell">WeChat / WA</th>
                ...
                <th className="px-5 py-3 text-right text-xs font-semibold text-bgray-500 dark:text-bgray-400 uppercase tracking-wide">Items</th>
              </tr>
            </thead>
                ...
                >
                  <td className="px-5 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-semibold text-darkblack-700 dark:text-white group-hover:text-primary transition-colors">{s.name}</span>
                    </div>
                  </td>
                  <td className="px-5 py-3 text-bgray-600 dark:text-bgray-300">{s.sales_person || <span className="text-bgray-300">—</span>}</td>
                  <td className="px-5 py-3 text-bgray-600 dark:text-bgray-300 hidden md:table-cell">{s.email || <span className="text-bgray-300">—</span>}</td>
                  <td className="px-5 py-3 text-bgray-600 dark:text-bgray-300 hidden lg:table-cell">{s.wechat_or_whatsapp || <span className="text-bgray-300">—</span>}</td>
                  <td className="px-5 py-3 text-bgray-600 dark:text-bgray-300 hidden lg:table-cell">{s.country || <span className="text-bgray-300">—</span>}</td>
